    ...
    style={bg_style}>
        ...
        style={{"backgroundColor": "rgba(0, 0, 0, 0.6)"}}>
            <div className="flex flex-col backdrop-opacity-10 backdrop-invert bg-white/5 mb-96 px-20  text-white items-center m-auto justify-center rounded-lg border-none border-2 w-full max-w-md">     
                <h2 className="mb-7 font-roboto text-4xl pt-7">About me</h2>
                <p className='font-roboto text-center mb-7'>I am a Front-end developer from North Carolina. I am a passionate Chelsea fan who likes to travel, eat and explore new things in life.     </p>
                <Link to="/blogs">
                    <Buttons label={"Explore"} myMar="mb-7"/>
                </Link>                          
            </div>
        </div>
